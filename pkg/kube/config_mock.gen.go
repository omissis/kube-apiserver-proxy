...
type MockRESTConfigFactory struct {
	...
	recorder *MockRESTConfigFactoryMockRecorder
}
...
func NewMockRESTConfigFactory(ctrl *gomock.Controller) *MockRESTConfigFactory {
	mock := &MockRESTConfigFactory{ctrl: ctrl}
	mock.recorder = &MockRESTConfigFactoryMockRecorder{mock}
	return mock
}
...
func (m *MockRESTConfigFactory) New(kubeconfigPath string) (*rest.Config, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "New", kubeconfigPath)
